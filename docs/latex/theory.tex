...
\centering
\begin{tikzpicture}
\draw[thick,dotted,->] (0,7) -- (0,0);
\draw[thick,dotted,->] (0,7) -- (7,7);
\draw (0,0) node[anchor=west]{$v$};
\draw (7,7) node[anchor=north]{$u$};

\draw[thick] (3.5,3.5) circle (3);
\draw[rotate around={-20:(3.5,3.5)},thick,dotted,-] (3.5,3.5) -- (6.5,3.5);
\draw[rotate around={-20:(3.5,3.5)}] (6.5,3.5) node[anchor=west]{$\theta = 0^\circ$};

\filldraw[black] (3.5,3.5) circle (2pt) node[anchor=east]{$O (u_0, v_0)$};
\filldraw[black] (5.5,4) circle (2pt) node[anchor=north]{$P_1 (u_1, v_1)$};
\filldraw[black] (3,6) circle (2pt) node[anchor=north]{$P_2 (u_2, v_2)$};
\filldraw[black] (4,5) circle (2pt) node[anchor=north]{$P (u, v)$};

\end{tikzpicture}
\caption{Polar diagram}
\end{figure}
